...
skills_data = {
    ...
    "Python":              [3,         3,       0,        0,         0],
    "SQL":                 [4,         3,       0,        0,         0],
    "Machine Learning":    [2,         2,       0,        0,         0],
    "AWS":                 [2,         0,       0,        0,         0],
    "Cloud Computing":     [0,         2,       0,        0,         0],
    "NLP":                 [0,         1,       0,        0,         0],
    "Data Visualization":  [4,         5,       0,        0,         0],
...
fig.write_image("figures/skill_heatmap.png", width=1100, height=500, scale=2)
fig.show()
```
...
```{python}
# Map Lightcast skill names to team skill columns
skill_map = {
...
# Baseline expectation of 3 for unmapped skills
...
fig2.write_image("figures/skill_gap_bar.png", width=1100, height=550, scale=2)
fig2.show()
```
...
|---|---|---|
| Antara | Machine Learning, Statistics, NLP | Coursera ML, fast.ai |
| Julie | NLP, AWS, Statistics | Hugging Face NLP course, AWS Training |
| Yifan | TBD | TBD |
| Zhiyang | TBD | TBD |
| Alina | TBD | TBD |
...
- **Julie** leads: Data Visualization, EDA, Cloud Computing
- **Yifan** leads: TBD
- **Zhiyang** leads: TBD
- **Alina** leads: TBD
