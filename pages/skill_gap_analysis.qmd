...
skills_data = {
    ...
    "Python":             [3,         3,       0,        3,         3],
    "SQL":                [4,         3,       0,        3,         3],
    "Machine Learning":   [2,         2,       0,        2,         1],
    "AWS":                [2,         2,       0,        5,         2],
    "Data Visualization": [4,         5,       0,        3,         4],
    "Statistics":         [2,         3,       0,        2,         2],
    "Big Data / Spark":   [2,         2,       0,        2,         2],
    "Excel":              [4,         4,       0,        5,         3],
    "Business Analytics": [4,         4,       0,        4,         4],
}
...
- **Yifan** leads: TBD
- **Zhiyang** leads: TBD
- **Alina** leads: Skill Gap Analysis, Career Strategy, Insights & Presentation
